...
const CallToAction = () => {
  return (
    <section className="bg-[#0E0B16] text-[#F8F9FA] py-20 px-6 text-center min-h-screen flex items-center">
      ...
      >
        {/* Heading */}
        <h2 className="text-3xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#9D4EDD] to-[#FFB347]">
        ...
        <motion.div whileHover={{ scale: 1.1 }}>
          <NavLink
            ...
            className="bg-[#FFB347] text-[#0E0B16] px-8 py-3 rounded-full text-lg font-semibold 
                       hover:bg-[#ffca66] transition duration-300 shadow-lg hover:shadow-[#9D4EDD]/50"
          >
            Contact Me
          </NavLink>
        </motion.div>
